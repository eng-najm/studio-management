...
public class AttendancePage extends JPanel {
    ...
    public AttendancePage() {
        ...
        tableModel = new AttendanceTable(new ArrayList<>());
        ...
        topPanel.add(new AppLable("Attendance Management"), BorderLayout.CENTER);
        topPanel.add(buttonPanel, BorderLayout.EAST);

        tablePanel.add(topPanel, BorderLayout.NORTH);
    }

    public void populateAttendanceList(List<AttendanceModel> attendances) {
        tableModel = new AttendanceTable(attendances);
    ...
    public AttendanceTable getTableModel() { return tableModel; }
