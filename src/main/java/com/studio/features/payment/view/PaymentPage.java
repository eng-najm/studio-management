...
public class PaymentPage extends JPanel {
    ...
    public PaymentPage() {
        ...
        tableModel = new PaymentTable(new ArrayList<>());
        ...
        topPanel.add(new AppLable("Payment Management"), BorderLayout.CENTER);
        topPanel.add(buttonPanel, BorderLayout.EAST);

        tablePanel.add(topPanel, BorderLayout.NORTH);
    }

    public void populatePaymentList(List<PaymentModel> payments) {
        tableModel = new PaymentTable(payments);
    ...
    public PaymentTable getTableModel() { return tableModel; }
