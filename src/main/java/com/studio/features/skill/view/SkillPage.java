...
public class SkillPage extends JPanel {
    ...
    public SkillPage() {
        ...
        tableModel = new SkillTable(new ArrayList<>());
        ...
        topPanel.add(new AppLable("Skill Management"), BorderLayout.CENTER);
        topPanel.add(buttonPanel, BorderLayout.EAST);

        tablePanel.add(topPanel, BorderLayout.NORTH);
    }

    public void populateSkillList(List<SkillModel> skills) {
        tableModel = new SkillTable(skills);
    ...
    public SkillTable getTableModel() {
        return tableModel;
    }
